"""Here n*n queen problem queen is represented as '1'"""
import numpy as np
...
def get_Input(length,sample_size):
    ...
    print("The Success percent is = "+str(percent))
    print("Average success steps required: "+str(np.average(avg_success_steps)))
    print("Average failure steps required:"+str(np.average(avg_failure_steps)))
